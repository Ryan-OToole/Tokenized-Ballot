...
const MINT_VALUE = ethers.utils.parseEther(".00001");
...
async function main() {
    ...
    console.log("balance b4 transfer", initialBalance);
    const tx = await tokenContract.transfer(process.argv[3], MINT_VALUE.div(2));
    await tx.wait();
